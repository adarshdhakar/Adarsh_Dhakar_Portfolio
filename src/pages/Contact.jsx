  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-100">
      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">I'd love to hear from you!</h2>
          <p className="mb-6">
            If you have any questions, feedback, or opportunities for collaboration, feel free to reach out to me using the form below. I'm always open to discussing new projects, ideas, or anything else you might have in mind.
          </p>
